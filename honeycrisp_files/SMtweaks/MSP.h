...
public:
  ...
  void Initialize_Shamir(unsigned int n, unsigned int t, unsigned int* evalPoints);
  ...
  MSP(unsigned int n, unsigned int t, unsigned int* evalPoints)
  {
    Initialize_Shamir(n, t, evalPoints);
  }
  MSP(const CAS &AS)
  {
